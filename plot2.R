...
# Plot 2
plot(data$Time,data$Global_active_power,type="l",bg="white", xlab="",ylab="Global Active Power (kilowatts)")

#Print the chart in a 480x 480 png file best viewed using windows photo viewer
dev.copy(png,height=480,width=480,units="px", pointsize=12, file="plot2.png")
